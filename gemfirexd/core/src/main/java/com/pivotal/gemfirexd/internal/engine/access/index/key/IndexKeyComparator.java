    ...
    if (ccik1 != null) {
      ...
      if (indexInfo == null) {
        throw RegionEntryUtils
            .checkCacheForNullTableInfo("HeapIndexKeyComparator#compare");
      }
      int tries = 1;
      for (;;) {
        ...
        if (tries > CompactCompositeIndexKey.MAX_TRIES) {
          throw RegionEntryUtils
              .checkCacheForNullKeyValue("HeapIndexKeyComparator#compare");
        }
      }
    }
    if (ccik2 != null) {
    ...
    for (int i = 0; i < cmpLen; i++) {
      try {
        ...
        throw GemFireXDRuntimeException.newRuntimeException(
            "HeapIndexKeyComparator#compare: unexpected exception", se);
      }
    }
