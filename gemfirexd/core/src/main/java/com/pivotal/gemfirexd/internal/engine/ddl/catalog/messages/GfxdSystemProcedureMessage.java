...
public final class GfxdSystemProcedureMessage extends
  ...
  public enum SysProcMethod {
    ...
    setDatabaseProperty {
      ...
      @Override
      public void processMessage(Object[] params, EmbedConnection conn,
    ...
    createUser {
      ...
      public void processMessage(Object[] params, EmbedConnection conn,
        ...
        if (GemFireXDUtils.TraceSysProcedures) {
          SanityManager.DEBUG_PRINT(GfxdConstants.TRACE_SYS_PROCEDURES,
              "creating distributed system user (" + key + "," + value + "). ");
    ...
    dropUser {
      ...
      public void processMessage(Object[] params, EmbedConnection conn,
        ...
        String key = (String)params[0];
        Misc.getMemStoreBooting().setProperty(key, null, false);

        if (GemFireXDUtils.TraceSysProcedures) {
          SanityManager.DEBUG_PRINT(GfxdConstants.TRACE_SYS_PROCEDURES,
              "dropped distributed system user (" + key + ") ");
        }
      }
    ...
    setNanoTimerType {
      ...
      String getSQLStatement(Object[] params) throws StandardException {
        final StringBuilder sb = new StringBuilder();
        return sb.append("CALL SYS.SET_NANOTIMER_TYPE('")
            .append(params[0]).append("','").append(params[1]).append(')').toString();
      }
    },
    ;
    ...
    public abstract void processMessage(Object[] params, EmbedConnection conn,
        DistributedMember sender) throws StandardException;
  ...
  public void execute() throws StandardException {
    ...
    this.procMethod.processMessage(this.params, null, sender);
  }
