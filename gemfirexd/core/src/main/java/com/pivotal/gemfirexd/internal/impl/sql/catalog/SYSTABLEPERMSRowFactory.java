/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.SYSTABLEPERMSRowFactory
...
public class SYSTABLEPERMSRowFactory extends PermissionsCatalogRowFactory
{
    ...
    private static final int ALTERPRIV_COL_NUM = 11;
	...
	public ExecRow makeRow(TupleDescriptor td, TupleDescriptor parent) throws StandardException
	{
        ...
        row.setColumn( ALTERPRIV_COL_NUM, new SQLChar(alterPriv));
		...
		throws StandardException
    {
        ...
        String alterPriv  = row.getColumn( ALTERPRIV_COL_NUM).getString();
        ...
        if( SanityManager.DEBUG)
        {
            ...
            SanityManager.ASSERT( "y".equals(alterPriv) || "Y".equals(alterPriv) || "N".equals(alterPriv),
                                  "Invalid SYSTABLEPERMS.alterPriv column value: " + alterPriv);
        }
        ...
        throws StandardException
    {
        return new SystemColumn[] {
            ...
            SystemColumnImpl.getIndicatorColumn("ALTERPRIV"),
        };
    }
        ...
        throws StandardException
    {
        ...
        changeCount += orOnePermission( row, colsChanged, ALTERPRIV_COL_NUM, tablePerms.getAlterPriv());
        ...
        throws StandardException
    {
        ...
        boolean permissionsLeft =
          ( removeOnePermission( row, colsChanged, SELECTPRIV_COL_NUM, tablePerms.getSelectPriv()) |
            ...
            removeOnePermission( row, colsChanged, ALTERPRIV_COL_NUM, tablePerms.getAlterPriv()));
        if( ! permissionsLeft)
            return -1;
