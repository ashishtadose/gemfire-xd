...
public class GemFireXDZipSelfExtractor extends ZipSelfExtractor {

  private final static String GEMSTONE_JAR = "gemfire.jar";

  private final static String GEMSTONE_PATTERN =
    ".*/com/gemstone/(?!(?:org/jgroups)|(?:gnu/trove)).*";

  private final static String JGROUPS_JAR = "jgroups.jar";

  private final static String JGROUPS_PATTERN =
    ".*/com/gemstone/org/jgroups/.*";
  ...
  protected String getInstallDirProperty() {
    return "gemfirexd.installer.directory";
  }

  protected String getInstallOpenSourceProperty() {
    return "gemfirexd.installer.opensource";
  }

  GemFireXDZipSelfExtractor() {
    super();
  }

  public static void main(String[] args) throws Throwable {
    ZipSelfExtractor zse = new GemFireXDZipSelfExtractor();
    zse.installProduct();
  }
}
