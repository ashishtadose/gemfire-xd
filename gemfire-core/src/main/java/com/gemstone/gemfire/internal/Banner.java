...
public class Banner {
	...
	out.println();
        out.println("  Copyright (C) 1997-2014 Pivotal Software, Inc. All rights reserved. This");
        ...
        out.println("  of trademark of GoPivotal, Inc. in the United States and/or other");
